...
const Portfolio = () => {
  ...
  {categories.map((cat) => (
    <button
      ...
      className={`px-3.5 py-2 rounded-full text-[11px] font-bold transition-all duration-300 border whitespace-nowrap tracking-tight ${
        activeFilter === cat
          ? "bg-hijau-fandy text-white border-hijau-fandy shadow-md"
